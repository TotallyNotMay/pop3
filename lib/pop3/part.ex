defmodule Pop3.Part do
   ...
   @type t :: %Pop3.Part{index: integer, media_type: String.t, charset: String.t, path: String.t, filename: binary, filename_charset: String.t, boundary: String.t, content: binary, content_id: String.t, content_location: String.t, inline: boolean | nil}
