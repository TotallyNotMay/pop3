defmodule Pop3.Multipart do
  alias Pop3.Base64Decoder
  alias Pop3.Part
  alias Pop3.QuotedPrintable
  alias Pop3.StringUtils
  alias Pop3.WordDecoder
  ...
  The returned sequential list of Pop3.Path structs is flattened. The Part.path field shows where it is in the hierarchy.
  This module can also be useful to parse RFC 7578 multipart/form-data (previously RFC 2388).
  """

   @doc """
   Parse multipart content. Returns a flattened list of Pop3.Part's

   This is recursively called for each multipart part, e.g. parse_content calls itself

   `multipart_part` - Pop3.Part input.
   """
   ...
   * `path` - path in the multipart hierarchy. For example: relative/alternative
   ...
   @doc """
   Decode lines and add them as content in the multipart part. Returns a Pop3.Part
   ...
   * `lines` - part content splitted in lines
   ...
   @doc """
   Finish parsing multipart header lines and start decode of the part content. Returns a Pop3.Part
   ...
   * `list` - lines
   ...
   @doc """
   Parse multipart header lines. Returns a Pop3.Part
   ...
   * `list` - lines
   ...
   # Some multipart headers are not interesting for pop3. Skip them.
   ...
   @doc """
   Parse multipart Content-Type header line. It can contain media_type, charset, (file-)name and boundary. Returns a Pop3.Part
   ...
   * `list` - lines
   ...
   @doc """
   Parse value of content-type header line. It can contain media_type, charset, (file-)name and boundary. Returns a Pop3.Part
   ...
   * `content_type_parameters` - list of parameters in the format key=value
   ...
   @doc """
   Parse multipart Content-ID header line. Returns a Pop3.Part
   ...
   * `list` - lines
   ...
   @doc """
   Parse multipart Content-Location header line as defined in RFC 2557. Returns a Pop3.Part
   ...
   * `list` - lines
   ...
   @doc """
   Parse multipart Content-Transfer-Encoding header line. Returns a Pop3.Part
   ...
   * `list` - lines
   ...
   @doc """
   Ignore a multipart header line. Returns a Pop3.Part
   ...
   * `list` - lines
   ...
   @doc """
   Skip an unknown multipart header line. Logs a warning. Returns a Pop3.Part
   ...
   * `list` - lines
   ...
   @doc """
   Parse multipart Content-Disposition header line. Returns a Pop3.Part
   ...
   * `list` - lines
   ...
   @doc """
   Parse multipart Content-Disposition header line. This is either inline or attachment, and it can contain a filename. Returns a Pop3.Part
   ...
   @doc """
   Parse value of Content-Disposition header line. This is either inline or attachment, and it can contain a filename. Returns a Pop3.Part
   ...
   * `disposition_parameters` - list of parameters in the format key=value
   ...
   @doc ~S"""
   Extract (file-)name from Content-Disposition value or Content-Type value. Returns Pop3.Part with filled-in filename and filename_charset.
   ...
   # Extract (file-)name from (file-)name list (together one value). Returns Pop3.Part with filled-in filename and filename_charset.
